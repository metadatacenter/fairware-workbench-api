...
public abstract class MetadataSpecification {
  ...
  public static MetadataSpecification create(@Nonnull @JsonProperty(TEMPLATE_ID) String templateId,
                                             ...
                                             @Nonnull @JsonProperty(TEMPLATE_FIELDS) ImmutableList<FieldSpecification> templateFields) {
  ...
  public abstract ImmutableList<FieldSpecification> getTemplateFields();
}
